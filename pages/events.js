...
export default function EventsPage() {
  ...
  const handleImageError = (e) => {
    if (e.target.src.includes('conference-2022')) {
      ...
      e.target.src = `https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=600&h=300&fit=crop`;
    } else {
      e.target.src = `https://images.unsplash.com/photo-1591115765373-5207764f72e7?w=600&h=300&fit=crop`;
    }
  };
