...
function Footer() {
  ...
  const footerLinks = {
    community: [
      {name: "Discord", href: "https://discord.gg/buildspace"},
      {name: "Twitter", href: "https://twitter.com/_buildspace"},
      {name: "GitHub", href: "https://github.com/buildspace"},
      {name: "YouTube", href: "https://youtube.com/@buildspace"},
    ],
    resources: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Empowering the next generation of African Web3 builders through education, community, and hands-on
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://github.com/buildspace"
                target="_blank"
                rel="noopener noreferrer"
                className={styles.socialLink}
        ...
        <div className="border-t border-gray-700 pt-8 mb-8">
          <div className="max-w-md mx-auto text-center lg:text-left lg:max-w-none lg:mx-0">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Get the latest updates on events, workshops, and community news.
            </p>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Buildspace Africa. All rights reserved.
            </div>
            <div className="flex space-x-6 text-sm">
              ...
              <a href="/code-of-conduct" className={styles.footerLink}>
                Code of Conduct
              </a>
            </div>
          </div>
