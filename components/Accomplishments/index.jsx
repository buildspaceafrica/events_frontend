...
const accomplishments = [
  {
    ...
    description:
      "Successfully hosted the first-ever Buildspace Africa blockchain conference, bringing together Web3 enthusiasts, developers, and innovators across the continent.",
    date: "January 2022",
    icon: "🎯",
    linkType: "internal",
    link: "/events/1",
  },
  {
    ...
    description:
      "Established a strategic partnership with Learnable to launch a comprehensive Web3 track, providing structured learning paths for African developers entering the blockchain space.",
    date: "2022-Present",
    icon: "🤝",
    linkType: "external",
